# require 'rake_helper.rb'

# namespace :bodegas do
#   desc "TODO"
#   task recibir: :environment do
...
#   desc "TODO"
#   task automatizar: :environment do
#   	loop do
#   		Rake::Task['bodegas:recibir'].reenable
#   		Rake::Task['bodegas:recibir'].invoke
#   		Rake::Task['bodegas:despachar'].reenable
#   		Rake::Task['bodegas:despachar'].invoke
#   	end
#   end
